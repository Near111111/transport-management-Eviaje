    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        livetrackingButton.setOnClickListener(v -> {
            if (username != null) {
                ...
                Intent profileIntent = new Intent(DrivenHomeScreen.this, MapsActivity.class);
        ...
        scheduleButton.setOnClickListener(v -> {
            if (username != null) {
                Log.d("EmployeeHomeScreen", "profileButton clicked");
                Intent profileIntent = new Intent(DrivenHomeScreen.this, DriverNewSchedule.class);
                profileIntent.putExtra("username", username);
                startActivity(profileIntent);
            } else {
                // Handle null username
        ...
        profileButton.setOnClickListener(v -> {
            if (username != null) {
                Log.d("EmployeeHomeScreen", "profileButton clicked");
                Intent profileIntent = new Intent(DrivenHomeScreen.this, DriverProfile.class);
                profileIntent.putExtra("username", username);
                startActivity(profileIntent);
            } else {
                // Handle null username
    ...
    private class GetPassengerListTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            if (result != null) {
                ...
                Toast.makeText(DrivenHomeScreen.this, "Failed to fetch passenger data from the API", Toast.LENGTH_SHORT).show();
            }
        }
    }
}
